...
require_once("../../app/controller/insidencias/datos_categoria.php");
?>
                        ...
                        <div class="card-body">
                            <form action="<?=APP_URL?>/app/controllers/roles/create.php" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="rol_name">Creado en la fecha</label>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <a href="<?=APP_URL.'admin/categoria'?>" class="btn btn-secondary">Volver</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
