...
require_once("../../../app/controller/producto/categoria/listado_categoria.php");
?>
...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container">
            <div class="container">
                <h1 class="text-center">CATEGORIA PRODUCTOS</h1>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-outline card-pink">
                        <div class="card-header">
                            <h3 class="card-title">CATEGORIA REGISTRADAS</h3>
                            <div class="card-tools">
                                <button class="btn bg-pink">
                                    <i class="nav-giticon fas"><i class="bi bi-file-text"></i></i></i>
                                    <a href="<?= APP_URL.'admin/productos/categorias/create.php'?>" class="text-white">NUEVO REGISTRO</a>
                                </button>   
                            </div>
                        </div>
                        <div class="card-body">
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                <form action="<?= APP_URL.'app/controller/producto/categoria/borrado_categoria.php'?>"
                                                    ...
                                                    <input type="text" name="id_pcat" value="<?=$id_catg ?>" hidden>
