            ...
            <div class=" row">
                ...
                <div class="col-md-6">
                    <div class="card card-outline card-pink">
                        ...
                        <div class="card-body">
                            <form action="<?=APP_URL.'app/controller/producto/categoria/create_categoria.php'?>" method="post">
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <a href="<?=APP_URL.'admin/productos/categorias/categoria.php'?>" class="btn btn-secondary">Cancelar</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
