                        ...
                        <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="text" value="<?=$costo_price?>" class="form-control" disabled>
                                    </div>
                                    <div class="col-4">
                                        <label>PRECIO VENTA <span class="text-danger">*</span></label>
                                        <input type="text" value="<?=$venta_price?>" class="form-control" disabled>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <a href="<?= APP_URL . 'admin/productos/index.php' ?>" class="btn btn-secondary">VOLVER</a>
                                        </div>
                                    </div>
                                </div>
                        </div>
